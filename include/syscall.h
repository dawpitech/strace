...
const static syscall_t table[330] = {
    {0, "read", 3, NUM, NUM, VOID_P, NUM, 0, 0, 0},
    {1, "write", 3, NUM, STRING, NUM, NUM, 0, 0, 0},
    ...
    {21, "access", 2, STRING, NUM, NUM, 0, 0, 0, 0},
    ...
    {38, "setitimer", 3, NUM, NUM, CONST_STRUCT_ITIMERVAL_P,
        STRUCT_ITIMERVAL_P, 0, 0, 0}, {39, "getpid", 1, NUM, VOID,
        0, 0, 0, 0, 0},
    ...
    {59, "execve", 3, STRING, STRING, STRING, STRING, 0, 0, 0},
    ...
    {144, "sched_setscheduler", 3, NUM, NUM, NUM, CONST_STRUCT_SCHED_PARAM_P,
        0, 0, 0}, {145, "sched_getscheduler", 1, NUM, NUM, 0, 0, 0, 0, 0},
    ...
    {180, "nfsservctl", 3, NUM, NUM, STRUCT_NFSCTL_ARG_P, UNION_NFSCTL_RES_P,
        0, 0, 0}, {181, "getpmsg", 6, 0, 0, 0, 0, 0, 0, 0},
    ...
    {257, "openat", 3, NUM, STRING, NUM, NUM, 0, 0, 0},
    ...
    {274, "get_robust_list", 3, NUM, NUM, STRUCT_ROBUST_LIST_HEAD_P, NUM_P, 0,
        0, 0}, {275, "splice", 6, NUM, NUM, LNUM_P, NUM, LNUM_P,
        NUM, UNSIGNED},
    ...
    {314, "sched_setattr", 3, NUM, NUM, STRUCT_SCHED_ATTR_P, UNSIGNED,
        0, 0, 0},
    {315, "sched_getattr", 4, NUM, NUM, STRUCT_SCHED_ATTR_P,
